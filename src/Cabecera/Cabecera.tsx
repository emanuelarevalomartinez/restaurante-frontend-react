...
export function Cabecera() {
    ...
    return (
        <header className={`px-4 pt-4 z-30`}>
            <div className={`flex flex-col gap-4 mb-6 md:flex-row md:justify-start md:items-center`}>
                <div className="flex flex-col w-full">
                    <h1 className="flex flex-wrap flex-row text-gray-300 text-xl col-span-2 text-start md:text-center gap-2">Bienvenido al Restaurante 
