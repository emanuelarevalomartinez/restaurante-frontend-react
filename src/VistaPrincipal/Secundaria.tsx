...
export function Secundaria({ visivility, changeVisilitySecundaria }: Props) {
    ...
    return (
     ...
     <div className={`w-full h-full fixed top-0 col-span-2 lg:min-h-screen lg:w-3/12 lg:left-3/4 bg-[#1F1D2B] transition-all ${visivility ? 'right-0' : '-right-full'}`}>
...
<div className="flex flex-wrap items-center gap-2 p-2">
    <AccionEnCarrito nombre={"Borrar pedidos"} />
    <AccionEnCarrito nombre={"Borrar notas"} />
</div>
